...
import { getActiveUser } from "./userDirectory";
...
export default function FormPage() {
  ...
  if (submitted) {
    return (
      <div className="relative w-full min-h-screen bg-gradient-to-br from-slate-100 to-gray-200 pb-20 flex flex-col">
